...
# Doplň funkci pohyb tak, aby zamezila: pohybu ven z mapy, pohybu na políčko, které už v seznamu je. 
...
# Když had sežere ovoce, vyroste („nesmaže“ se mu ocas, tedy neprovede se to, cos přidala v projektu 13), a pokud na mapě zrovna není 
# další ovoce, na náhodném místě (kde není had) vyroste ovoce nové. Každých 30 tahů vyroste nové ovoce samo od sebe. 
